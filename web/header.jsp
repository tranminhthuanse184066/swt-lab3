            ...
            <div class="container-fluid"> <%-- Fluid container for better responsiveness --%>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                    ...
                    <form action="MainController" method="GET" class="d-flex">
                        ...
                        <button class="btn btn-primary btn-sm ms-2" type="submit" name="action" value="SearchProduct">Search</button>
                    </form>

                    <ul class="navbar-nav">
                        <c:choose>
                            <c:when test="${empty LOGIN_USER}">
                                <li class="nav-item"><a class="nav-link" href="MainController?action=Login"><span class="material-symbols-outlined">person</span></a></li>
                                <li class="nav-item"><a class="nav-link" href="MainController?action=Register"><span class="material-symbols-outlined">shopping_cart</span></a></li>
                                </c:when>
                                <c:otherwise>
